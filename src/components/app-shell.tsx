...
export function AppShell({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen">
      <header className="flex items-center justify-between gap-3 px-4 h-14 border-b border-line bg-card">
      ...
      <nav className="fixed bottom-0 inset-x-0 border-t border-line bg-card flex">
